...
// Event listener called the startTime () to begin the timer.  
// Next the hideStartArea () is called to hide the <h1>, <p>, and <button> elements. 
// Then the displayQuestion () is called to display the first question.
...
function hideMainArea() {
    ...
    newHeadDiv.style.display = "none";
    newPDiv.style.display = "none";
    //startButton.style.display = "none"
}
